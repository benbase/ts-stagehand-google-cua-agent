/**
 * Navigator Stg - Computer Use Agent using Kernel's Computer Controls API
 *
 * Staging environment copy of the navigator app.
 * Promoted from navigator-dev after validation. Promote to navigator (prod) when ready.
 *
...
const app = kernel.app('navigator-STG');
