/**
 * Navigator Dev - Computer Use Agent using Kernel's Computer Controls API
 *
 * Development environment copy of the navigator app.
 * Make experimental changes here, then promote to navigator-stg and navigator (prod).
 *
...
const app = kernel.app('navigator-DEV');
